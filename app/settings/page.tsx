...
type Profile = { id: string; name?: string; email?: string; username?: string; onboarding_complete?: boolean; onboarding_draft?: Record<string, any> };
...
export default function SettingsPage() {
  ...
  async function save() {
    ...
    setProfile({ ...profile, username: nextUsername, display_name: displayName, onboarding_draft: nextDraft } as Profile);
