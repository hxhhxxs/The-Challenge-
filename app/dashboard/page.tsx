...
function hijriLabel(date: Date) {
  try { return new Intl.DateTimeFormat("en-US-u-ca-islamic", { day: "numeric", month: "long", year: "numeric" }).format(date); } catch { return "Hijri date"; }
}
        ...
        <header className="rounded-[2rem] bg-slate-950 p-6 text-white">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="text-center">
              <p className="text-xs font-black text-emerald-300">Dashboard live build v4</p>
