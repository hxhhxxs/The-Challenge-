...
const scoreText = (v: number) => v > 0 && v < 1 ? v.toFixed(3) : v.toFixed(1);
...
function draftLogs(draft: any): Array<[string, any]> { return Object.entries(draft?.checkins || {}).map(([date, log]: [string, any]) => [date, { ...log, date, totals: totalsFrom(log) }] as [string, any]).sort(([a], [b]) => a.localeCompare(b)); }
